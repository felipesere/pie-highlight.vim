...
setlocal indentexpr=
setlocal lisp
setlocal lispwords+=claim,λ,Π,Σ,=,cons,::,which-Nat,iter-Nat,rec-Nat,ind-Nat,rec-List,ind-List,vec::,cong,replace,ind-Vec,ind-Either,left,right,ind-Absurd,Either
